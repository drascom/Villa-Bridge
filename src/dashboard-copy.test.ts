...
test("Devices kartları görsel ayrıntı düzeni ve koşullu dikkat bölümü sunar", async () => {
  ...
  assert.match(dashboard, /@media\(min-width:1151px\)\{\.device-grid\.devices-grid-view\[data-device-columns="5"\] \.device-card-header,\.device-grid\.devices-grid-view\[data-device-columns="6"\] \.device-card-header\{flex-direction:column;align-items:center;gap:9px;text-align:center\}/);
  assert.match(dashboard, /\[data-device-columns="6"\] \.device-card-toggle\{min-height:0;align-self:auto;padding:4px 0\}/);
  assert.match(dashboard, /\[data-device-columns="6"\] \.device-meta-text\{white-space:normal\}/);
  assert.match(dashboard, /\[data-device-columns="6"\] \.device-card-hint\{display:none\}\}/);
  ...
  assert.match(dashboard, /\.device-card\.command-failed\{border-color:var\(--danger\)/);
  assert.match(dashboard, /:root\[data-theme="dark"\] \.device-card\.command-failed\{border-color:#c86058/);
  ...
  assert.match(dashboard, /#devices \.page-head \.lead\{display:none\}/);
  ...
  assert.match(dashboard, /@media\(max-width:560px\)\{\.device-grid\.devices-grid-view\[data-device-columns="3"\][^{]*\{grid-template-columns:repeat\(2,minmax\(0,1fr\)\)\}\}/);
  ...
  assert.match(dashboard, /@media\(max-width:1150px\)\{\.device-grid\.devices-grid-view\[data-device-columns="5"\][^{]*\{grid-template-columns:repeat\(4,minmax\(0,1fr\)\)\}\}/);
  ...
  assert.match(dashboard, /id="deviceColumns" type="range" min="1" max="6"/);
